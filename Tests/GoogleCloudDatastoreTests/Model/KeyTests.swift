...
@Suite struct KeyTests {
  ...
  @Test func coding_ParentableNamespaceableKey() throws {
    try assertCodable(
      source: ParentableNamespaceableKeyEntity.Key.named(
        "c", parent: .named("p", namespace: .test1), namespace: .test1))
  }
  ...
  @Test func description_IndependentKey() throws {
    #expect(
      IndependentKeyEntity.Key.named("c").debugDescription == ".Testttt-IndependentKeyEntity:\"c\"")
  }
  ...
  @Test func description_ParentableNamespaceableKey() throws {
    #expect(
      ParentableNamespaceableKeyEntity.Key.named(
        "c", parent: .named("p", namespace: .test1), namespace: .test1
      ).debugDescription
