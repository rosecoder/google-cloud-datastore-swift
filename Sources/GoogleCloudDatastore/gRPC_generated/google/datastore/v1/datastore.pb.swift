...
package struct Google_Datastore_V1_Mutation: Sendable {
  ...
  package var conflictResolutionStrategy: Google_Datastore_V1_Mutation.ConflictResolutionStrategy = .strategyUnspecified
  ...
  package var propertyTransforms: [Google_Datastore_V1_PropertyTransform] = []
  ...
  package enum ConflictResolutionStrategy: SwiftProtobuf.Enum, Swift.CaseIterable {
    package typealias RawValue = Int

    /// Unspecified. Defaults to `SERVER_VALUE`.
    case strategyUnspecified // = 0
    ...
    package init?(rawValue: Int) {
      switch rawValue {
      case 0: self = .strategyUnspecified
      case 1: self = .serverValue
      case 3: self = .fail
      default: self = .UNRECOGNIZED(rawValue)
      }
    }
    ...
    package var rawValue: Int {
      switch self {
      case .strategyUnspecified: return 0
      case .serverValue: return 1
      case .fail: return 3
      case .UNRECOGNIZED(let i): return i
      }
    }
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    package static let allCases: [Google_Datastore_V1_Mutation.ConflictResolutionStrategy] = [
      .strategyUnspecified,
      .serverValue,
      .fail,
    ]
...
package struct Google_Datastore_V1_PropertyTransform: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// must be escaped.
  package var property: String = String()

  /// The transformation to apply to the property.
  package var transformType: Google_Datastore_V1_PropertyTransform.OneOf_TransformType? = nil

  /// Sets the property to the given server value.
  package var setToServerValue: Google_Datastore_V1_PropertyTransform.ServerValue {
    get {
  ...
  package var increment: Google_Datastore_V1_Value {
    get {
  ...
  package var maximum: Google_Datastore_V1_Value {
    get {
  ...
  /// NaN is NaN.
  package var minimum: Google_Datastore_V1_Value {
    get {
  ...
  package var appendMissingElements: Google_Datastore_V1_ArrayValue {
    get {
  ...
  ///
  /// The corresponding transform result will be the null value.
  package var removeAllFromArray: Google_Datastore_V1_ArrayValue {
    get {
  ...
  /// The transformation to apply to the property.
  package enum OneOf_TransformType: Equatable, Sendable {
    /// Sets the property to the given server value.
    case setToServerValue(Google_Datastore_V1_PropertyTransform.ServerValue)
    /// Adds the given value to the property's current value.
    ///
    /// This must be an integer or a double value.
    /// If the property is not an integer or double, or if the property does not
    ...
    /// If there is positive/negative integer overflow, the property is resolved
    /// to the largest magnitude positive/negative integer.
    case increment(Google_Datastore_V1_Value)
    /// Sets the property to the maximum of its current value and the given
    /// value.
    ///
    /// This must be an integer or a double value.
    ...
    /// zero input value is always the stored value.
    /// The maximum of any numeric value x and NaN is NaN.
    case maximum(Google_Datastore_V1_Value)
    /// Sets the property to the minimum of its current value and the given
    /// value.
    ///
    /// This must be an integer or a double value.
    ...
    /// value is always the stored value. The minimum of any numeric value x and
    /// NaN is NaN.
    case minimum(Google_Datastore_V1_Value)
    /// Appends the given elements in order if they are not already present in
    /// the current property value.
    /// If the property is not an array, or if the property does not yet exist,
    /// it is first set to the empty array.
    ...
    ///
    /// The corresponding transform result will be the null value.
    case appendMissingElements(Google_Datastore_V1_ArrayValue)
    /// Removes all of the given elements from the array in the property.
    /// If the property is not an array, or if the property does not yet exist,
    /// it is set to the empty array.
    ///
    ...
    ///
    /// The corresponding transform result will be the null value.
    case removeAllFromArray(Google_Datastore_V1_ArrayValue)

  }

  /// A value that is calculated by the server.
  package enum ServerValue: SwiftProtobuf.Enum, Swift.CaseIterable {
    package typealias RawValue = Int
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    package static let allCases: [Google_Datastore_V1_PropertyTransform.ServerValue] = [
      .unspecified,
      .requestTime,
    ]
...
package struct Google_Datastore_V1_MutationResult: Sendable {
  ...
  package var transformResults: [Google_Datastore_V1_Value] = []
...
extension Google_Datastore_V1_Mutation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    10: .standard(proto: "conflict_resolution_strategy"),
    9: .standard(proto: "property_mask"),
    12: .standard(proto: "property_transforms"),
  ]
  ...
  package mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 10: try { try decoder.decodeSingularEnumField(value: &self.conflictResolutionStrategy) }()
      case 11: try {
      ...
      case 12: try { try decoder.decodeRepeatedMessageField(value: &self.propertyTransforms) }()
      default: break
      }
    }
  }
  ...
  package func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.conflictResolutionStrategy != .strategyUnspecified {
      try visitor.visitSingularEnumField(value: self.conflictResolutionStrategy, fieldNumber: 10)
    }
    try { if case .updateTime(let v)? = self.conflictDetectionStrategy {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 11)
    } }()
    if !self.propertyTransforms.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.propertyTransforms, fieldNumber: 12)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  package static func ==(lhs: Google_Datastore_V1_Mutation, rhs: Google_Datastore_V1_Mutation) -> Bool {
    ...
    if lhs.conflictResolutionStrategy != rhs.conflictResolutionStrategy {return false}
    if lhs._propertyMask != rhs._propertyMask {return false}
    if lhs.propertyTransforms != rhs.propertyTransforms {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Google_Datastore_V1_Mutation.ConflictResolutionStrategy: SwiftProtobuf._ProtoNameProviding {
  package static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    0: .same(proto: "STRATEGY_UNSPECIFIED"),
    1: .same(proto: "SERVER_VALUE"),
    3: .same(proto: "FAIL"),
  ]
}

extension Google_Datastore_V1_PropertyTransform: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".PropertyTransform"
  package static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  package mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try {
        var v: Google_Datastore_V1_PropertyTransform.ServerValue?
  ...
  package static func ==(lhs: Google_Datastore_V1_PropertyTransform, rhs: Google_Datastore_V1_PropertyTransform) -> Bool {
...
extension Google_Datastore_V1_PropertyTransform.ServerValue: SwiftProtobuf._ProtoNameProviding {
  package static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Google_Datastore_V1_MutationResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    8: .standard(proto: "transform_results"),
  ]
  ...
  package mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 8: try { try decoder.decodeRepeatedMessageField(value: &self.transformResults) }()
      default: break
      }
    }
  }
  ...
  package func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.transformResults.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.transformResults, fieldNumber: 8)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
