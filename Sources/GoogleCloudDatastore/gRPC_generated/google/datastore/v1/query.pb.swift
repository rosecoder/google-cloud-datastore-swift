...
package struct Google_Datastore_V1_Query: @unchecked Sendable {
  ...
  package var findNearest: Google_Datastore_V1_FindNearest {
    get {return _storage._findNearest ?? Google_Datastore_V1_FindNearest()}
    set {_uniqueStorage()._findNearest = newValue}
  }
  /// Returns true if `findNearest` has been explicitly set.
  package var hasFindNearest: Bool {return _storage._findNearest != nil}
...
/// queries.
package struct Google_Datastore_V1_FindNearest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// returned.
  package var vectorProperty: Google_Datastore_V1_PropertyReference {
    get {return _vectorProperty ?? Google_Datastore_V1_PropertyReference()}
    set {_vectorProperty = newValue}
  }
  /// Returns true if `vectorProperty` has been explicitly set.
  package var hasVectorProperty: Bool {return self._vectorProperty != nil}
  /// Clears the value of `vectorProperty`. Subsequent reads from it will return its default value.
  package mutating func clearVectorProperty() {self._vectorProperty = nil}

  /// Required. The query vector that we are searching on. Must be a vector of no
  /// more than 2048 dimensions.
  package var queryVector: Google_Datastore_V1_Value {
    get {return _queryVector ?? Google_Datastore_V1_Value()}
    set {_queryVector = newValue}
  }
  /// Returns true if `queryVector` has been explicitly set.
  package var hasQueryVector: Bool {return self._queryVector != nil}
  ...
  package var distanceMeasure: Google_Datastore_V1_FindNearest.DistanceMeasure = .unspecified
  ...
  /// Returns true if `limit` has been explicitly set.
  package var hasLimit: Bool {return self._limit != nil}
  /// Clears the value of `limit`. Subsequent reads from it will return its default value.
  ...
  package var distanceResultProperty: String = String()
  ...
  package var hasDistanceThreshold: Bool {return self._distanceThreshold != nil}
  ...
  package enum DistanceMeasure: SwiftProtobuf.Enum, Swift.CaseIterable {
    package typealias RawValue = Int
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    package static let allCases: [Google_Datastore_V1_FindNearest.DistanceMeasure] = [
      .unspecified,
      .euclidean,
      .cosine,
      .dotProduct,
  ...
  fileprivate var _vectorProperty: Google_Datastore_V1_PropertyReference? = nil
  fileprivate var _queryVector: Google_Datastore_V1_Value? = nil
...
extension Google_Datastore_V1_Query: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  package static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    12: .same(proto: "limit"),
    13: .standard(proto: "find_nearest"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _findNearest: Google_Datastore_V1_FindNearest? = nil
  ...
  package mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 13: try { try decoder.decodeSingularMessageField(value: &_storage._findNearest) }()
        default: break
        }
      }
    }
...
extension Google_Datastore_V1_FindNearest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".FindNearest"
  package static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "vector_property"),
    2: .standard(proto: "query_vector"),
    3: .standard(proto: "distance_measure"),
    4: .same(proto: "limit"),
    5: .standard(proto: "distance_result_property"),
  ...
  package mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._vectorProperty) }()
      ...
      case 5: try { try decoder.decodeSingularStringField(value: &self.distanceResultProperty) }()
  ...
  package func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // are enabled. https://github.com/apple/swift-protobuf/issues/1034 and
    // https://github.com/apple/swift-protobuf/issues/1182
    try { if let v = self._vectorProperty {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    } }()
    ...
    if !self.distanceResultProperty.isEmpty {
      try visitor.visitSingularStringField(value: self.distanceResultProperty, fieldNumber: 5)
    }
  ...
  package static func ==(lhs: Google_Datastore_V1_FindNearest, rhs: Google_Datastore_V1_FindNearest) -> Bool {
    if lhs._vectorProperty != rhs._vectorProperty {return false}
    if lhs._queryVector != rhs._queryVector {return false}
    if lhs.distanceMeasure != rhs.distanceMeasure {return false}
    if lhs._limit != rhs._limit {return false}
    if lhs.distanceResultProperty != rhs.distanceResultProperty {return false}
...
extension Google_Datastore_V1_FindNearest.DistanceMeasure: SwiftProtobuf._ProtoNameProviding {
  package static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
