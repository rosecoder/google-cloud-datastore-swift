...
extension EntityEncoder {
  ...
  final class SingleValueContainer: SingleValueEncodingContainer, Encoder, EncodingContainer {
    ...
    func encode<T>(_ value: T) throws where T: Encodable {
      ...
      case let dictionary as [AnyHashable: Encodable]:
        let properties: [String: Google_Datastore_V1_Value] = .init(
          uniqueKeysWithValues: try dictionary.map { key, value in
